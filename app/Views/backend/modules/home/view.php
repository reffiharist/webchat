			...
			<div class="card-header pt-5">
				...
				<div class="card-title d-flex flex-column">
					...
					<div class="d-flex align-items-center">
						...
						<?=svgIcon('icons/duotune/arrows/arr066.svg', 'svg-icon svg-icon-5 svg-icon-success ms-n1')?>
			...
			<div class="card-header pt-5">
				...
				<div class="card-title d-flex flex-column">
					...
					<div class="d-flex align-items-center">
						...
						<?=svgIcon('icons/duotune/arrows/arr065.svg', 'svg-icon svg-icon-5 svg-icon-danger ms-n1')?>
						<!--end::Svg Icon-->2.2%</span>
						<!--end::Badge-->
					</div>
					<!--end::Info-->
			...
			<div class="card-body d-flex flex-column justify-content-end pe-0">
				...
				<div class="symbol-group symbol-hover flex-nowrap">
					...
					<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Michael Eberon">
						<img alt="Pic" src="<?=base_url('public/assets/admin')?>/media/avatars/300-11.jpg" />
					</div>
					<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Susan Redwood">
						<span class="symbol-label bg-primary text-inverse-primary fw-bold">S</span>
					</div>
					<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Melody Macy">
						<img alt="Pic" src="<?=base_url('public/assets/admin')?>/media/avatars/300-2.jpg" />
					</div>
					<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Perry Matthew">
						<span class="symbol-label bg-danger text-inverse-danger fw-bold">P</span>
					</div>
					<div class="symbol symbol-35px symbol-circle" data-bs-toggle="tooltip" title="Barry Walter">
						<img alt="Pic" src="<?=base_url('public/assets/admin')?>/media/avatars/300-12.jpg" />
					</div>
			...
			<div class="card-header py-5">
				...
				<div class="card-toolbar">
					...
					<button class="btn btn-icon btn-color-gray-400 btn-active-color-primary justify-content-end" data-kt-menu-trigger="click" data-kt-menu-placement="bottom-end" data-kt-menu-overflow="true">
						...
						<?=svgIcon('icons/duotune/general/gen023.svg', 'svg-icon svg-icon-1')?>
						<!--end::Svg Icon-->
					</button>
					<!--begin::Menu 2-->
				...
				<ul class="nav nav-pills nav-pills-custom mb-3">
					...
					<li class="nav-item mb-3 me-3 me-lg-6">
						...
						<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden active w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_1">
							<!--begin::Icon-->
							<div class="nav-icon">
								<img alt="" src="<?=base_url('public/assets/admin')?>/media/svg/products-categories/t-shirt.svg" class="" />
							</div>
							<!--end::Icon-->
							<!--begin::Subtitle-->
					...
					<li class="nav-item mb-3 me-3 me-lg-6">
						...
						<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_2">
							<!--begin::Icon-->
							<div class="nav-icon">
								<img alt="" src="<?=base_url('public/assets/admin')?>/media/svg/products-categories/gaming.svg" class="" />
							</div>
							<!--end::Icon-->
							<!--begin::Subtitle-->
					...
					<li class="nav-item mb-3 me-3 me-lg-6">
						...
						<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_3">
							<!--begin::Icon-->
							<div class="nav-icon">
								<img alt="" src="<?=base_url('public/assets/admin')?>/media/svg/products-categories/watch.svg" class="" />
							</div>
							<!--end::Icon-->
							<!--begin::Subtitle-->
					...
					<li class="nav-item mb-3 me-3 me-lg-6">
						...
						<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_4">
							<!--begin::Icon-->
							<div class="nav-icon">
								<img alt="" src="<?=base_url('public/assets/admin')?>/media/svg/products-categories/gloves.svg" class="nav-icon" />
							</div>
							<!--end::Icon-->
							<!--begin::Subtitle-->
					...
					<li class="nav-item mb-3">
						...
						<a class="nav-link d-flex justify-content-between flex-column flex-center overflow-hidden w-80px h-85px py-4" data-bs-toggle="pill" href="#kt_stats_widget_2_tab_5">
							<!--begin::Icon-->
							<div class="nav-icon">
								<img alt="" src="<?=base_url('public/assets/admin')?>/media/svg/products-categories/shoes.svg" class="nav-icon" />
							</div>
							<!--end::Icon-->
							<!--begin::Subtitle-->
						...
						<div class="table-responsive">
							...
							<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
								...
								<tbody>
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/210.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
									...
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/215.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
									...
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/209.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
						...
						<div class="table-responsive">
							...
							<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
								...
								<tbody>
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/197.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
											<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Elephant 1802</a>
											<span class="text-gray-400 fw-semibold fs-7 d-block text-start ps-0">Item: #XDG-4312</span>
									...
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/178.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
											<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
									...
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/22.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
											<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
						...
						<div class="table-responsive">
							...
							<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
								...
								<tbody>
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/1.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
									...
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/24.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
											<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
									...
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/71.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
											<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
						...
						<div class="table-responsive">
							...
							<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
								...
								<tbody>
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/41.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
									...
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/63.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
											<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">Red Laga</a>
									...
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/59.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
											<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6 text-start pe-0">RiseUP</a>
						...
						<div class="table-responsive">
							...
							<table class="table table-row-dashed align-middle gs-0 gy-4 my-0">
								...
								<tbody>
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/10.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
									...
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/96.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
									...
									<tr>
										<td>
											<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/13.gif" class="w-50px ms-n1" alt="" />
										</td>
										<td class="ps-0">
			...
			<div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
				...
				<div class="px-9 mb-5">
					...
					<div class="d-flex align-items-center mb-2">
						...
						<span class="badge badge-light-success fs-base">
						<!--begin::Svg Icon | path: icons/duotune/arrows/arr065.svg-->
						<?=svgIcon('icons/duotune/arrows/arr065.svg', 'svg-icon svg-icon-5 svg-icon-success ms-n1')?>
			...
			<div class="card-body d-flex flex-column flex-center">
				...
				<div class="mb-2">
					...
					<div class="py-10 text-center">
						<img src="<?=base_url('public/assets/admin')?>/media/svg/illustrations/easy/2.svg" class="theme-light-show w-200px" alt="" />
						<img src="<?=base_url('public/assets/admin')?>/media/svg/illustrations/easy/2-dark.svg" class="theme-dark-show w-200px" alt="" />
					</div>
					<!--end::Illustration-->
				</div>
				<!--end::Heading-->
				...
				<div class="card-toolbar">
					...
					<div class="d-flex flex-stack flex-wrap gap-4">
						...
						<div class="position-relative my-1">
							...
							<?=svgIcon('icons/duotune/general/gen021.svg', 'svg-icon svg-icon-2 position-absolute top-50 translate-middle-y ms-4')?>
							<!--end::Svg Icon-->
							...
							<td colspan="2">
								<div class="d-flex align-items-center gap-3">
									<a href="#" class="symbol symbol-50px bg-secondary bg-opacity-25 rounded">
										<img src="" data-kt-src-path="public/assets/admin/media/stock/ecommerce/" alt="" data-kt-table-widget-4="template_image" />
									</a>
						...
						<tr>
							...
							<td class="text-end">
								<button type="button" class="btn btn-sm btn-icon btn-light btn-active-light-primary toggle h-25px w-25px" data-kt-table-widget-4="expand_row">
									...
									<?=svgIcon('icons/duotune/arrows/arr087.svg', 'svg-icon svg-icon-3 m-0 toggle-off')?>
									<!--end::Svg Icon-->
									<!--begin::Svg Icon | path: icons/duotune/arrows/arr089.svg-->
									<?=svgIcon('icons/duotune/arrows/arr089.svg', 'svg-icon svg-icon-3 m-0 toggle-on')?>
									<!--end::Svg Icon-->
								</button>
							</td>
						</tr>
				...
				<div class="hover-scroll-overlay-y pe-6 me-n6" style="height: 415px">
					...
					<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
						...
						<div class="d-flex flex-stack mb-3">
							...
							<div class="me-3">
								<!--begin::Icon-->
								<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/210.gif" class="w-50px ms-n1 me-1" alt="" />
								<!--end::Icon-->
								<!--begin::Title-->
					...
					<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
						...
						<div class="d-flex flex-stack mb-3">
							...
							<div class="me-3">
								<!--begin::Icon-->
								<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/209.gif" class="w-50px ms-n1 me-1" alt="" />
								<!--end::Icon-->
								<!--begin::Title-->
					...
					<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
						...
						<div class="d-flex flex-stack mb-3">
							...
							<div class="me-3">
								<!--begin::Icon-->
								<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/214.gif" class="w-50px ms-n1 me-1" alt="" />
								<!--end::Icon-->
								<!--begin::Title-->
					...
					<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
						...
						<div class="d-flex flex-stack mb-3">
							...
							<div class="me-3">
								<!--begin::Icon-->
								<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/211.gif" class="w-50px ms-n1 me-1" alt="" />
								<!--end::Icon-->
								<!--begin::Title-->
								<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bold">Elephant 1802</a>
								<!--end::Title-->
					...
					<div class="border border-dashed border-gray-300 rounded px-7 py-3 mb-6">
						...
						<div class="d-flex flex-stack mb-3">
							...
							<div class="me-3">
								<!--begin::Icon-->
								<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/215.gif" class="w-50px ms-n1 me-1" alt="" />
								<!--end::Icon-->
								<!--begin::Title-->
								<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bold">RiseUP</a>
								<!--end::Title-->
					...
					<div class="border border-dashed border-gray-300 rounded px-7 py-3">
						...
						<div class="d-flex flex-stack mb-3">
							...
							<div class="me-3">
								<!--begin::Icon-->
								<img src="<?=base_url('public/assets/admin')?>/media/stock/ecommerce/192.gif" class="w-50px ms-n1 me-1" alt="" />
								<!--end::Icon-->
								<!--begin::Title-->
								<a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fw-bold">Yellow Stone</a>
								<!--end::Title-->
