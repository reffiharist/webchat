	...
	<div class="card-header align-items-center py-5 gap-2 gap-md-5">
		<div class="card-title">
			<div class="d-flex align-items-center position-relative my-1">
				...
				<input type="text" data-kt-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Package" />
			</div>
		</div>
	...
	<div class="modal-dialog modal-dialog-centered mw-650px">
		<div class="modal-content">
			<div class="modal-header" id="kt_modal_add_package_header">
				<h2 class="fw-bold">Add Package</h2>
			...
			<div class="modal-body scroll-y px-10 px-lg-15 pb-15">
				<form id="form" class="form" action="#" onsubmit="save(); return false" method="post">
					...
					<div class="fv-row mb-7">
						...
						<input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Package name" required />
					</div>
					<div class="fv-row mb-7">
					...
					<div class="fv-row mb-7">
						...
						<select class="form-select form-select-solid mb-3 mb-lg-0" data-control="select2" data-hide-search="true" name="type" aria-label="Select type" required>
						    ...
						    <?php foreach ($packageType as $key => $val): ?>
    						    <option value="<?=$key?>"><?=$val?></option>
						    <?php endforeach ?>
						</select>
					</div>
					<div class="fv-row mb-7">
						<label class="required fw-semibold fs-6 mb-2">Description List</label>
						<textarea name="desc" rows="5" class="form-control form-control-solid mb-3 mb-lg-0" required></textarea>
						<div class="text-muted">Pisahkan dengan tanda koma(,) setiap listnya</div>
					</div>
