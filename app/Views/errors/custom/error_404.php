...
<html lang="en">
	...
	<body data-kt-name="metronic" id="kt_body" class="bgi-size-cover bgi-position-center bgi-no-repeat">
		...
		<div class="d-flex flex-column flex-root" id="kt_app_root">
			<!--begin::Page bg image-->
			<style>body { background: url('<?=base_url("public/images/bg-line.png")?>') #233259; }</style>
			<!--end::Page bg image-->
				...
				<div class="d-flex flex-column flex-center text-center p-10">
					...
					<div class="card card-flush w-lg-650px py-5">
						<div class="card-body py-15 py-lg-20">
							...
							<!--begin::Illustration-->
							<div class="mb-3">
								<img src="<?=base_url('public/assets/admin/media/auth/404-error.png')?>" class="mw-100 mh-300px theme-light-show" alt="" />
								<img src="<?=base_url('public/assets/admin/media/auth/404-error-dark.png')?>" class="mw-100 mh-300px theme-dark-show" alt="" />
							</div>
							<!--end::Illustration-->
							<!--begin::Link-->
							<div class="mb-0">
								<a href="<?=site_url()?>" class="btn btn-sm btn-primary">Return Home</a>
							</div>
							<!--end::Link-->
						</div>
					</div>
